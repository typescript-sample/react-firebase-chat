...
export default function CarouselVideoItem(_a) {
    var item = _a.item;
    var btnVideoRef = React.useRef(null);
    var handlePlayVideo = function (e) {
        e.preventDefault();
        btnVideoRef.current.insertAdjacentHTML('afterend', "<video ref={videoRef} src=" + item.srcVideo + " poster=" + item.poster + " controls controlsList='nodownload' autoPlay ></video>");
    };
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: btnVideoRef, className: 'panel-container' },
            React.createElement("button", { className: 'btn-play', onClick: handlePlayVideo },
            ...
            React.createElement("img", { src: item.poster, alt: item.name }))));
}
//# sourceMappingURL=CarouselVideoItems.js.map