...
INSERT INTO modules (moduleid,modulename,status,path,resourcekey,icon,sequence,parent) VALUES ('chat','Chat','A','/chat','chat','chat',2,'');
INSERT INTO modules (moduleid,modulename,status,path,resourcekey,icon,sequence,parent) VALUES ('admin','Admin','A','/admin','admin','contacts',3,'');
...
INSERT INTO rolemodules(roleid,moduleid,permissions) VALUES ('admin','chat',7);
